...
public class TutorialWindow : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        openPanelsTutorial = "You have received your first piece of equipment! To equip it, you need to open the Character Panel. This can be done by clicking on the red vertical menu buttons in the bottom right of the screen or pressing C.\n\nIn order, these buttons are: Options, Character Panel, Quest Log.";
        HideCanvas();
    }
